...
module.exports = async (client) => {
    try {
        ...
        for (const localCommand of localCommands) {
            ...
            if (deleted) {
                if (existingCommand) {
                    ...
                    console.log(`[COMMAND REGISTERY] Application Command ${commandName} has been skipped, since property 'deleted' is true.`.gray)
                }
        ...
        console.log(`[ERROR] an error occurred in command registery:\n ${error}`.red);
    }
}